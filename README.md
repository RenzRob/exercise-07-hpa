...
|------|-------|-------------------|
| **U4.4 Kubernetes autoscaling, U4.5 Cloud elasticity** | U4.4 Kubernetes autoscaling, U4.5 Cloud elasticity | Deploy to K8s with HPA. Write a load test with Locust. Observe auto-scaling. |
...
**Deadline: July 1, 2026 at 23:59 UTC-3** (3 late days allowed with penalty)

---

## Context

Deploy to K8s with HPA. Write a load test with Locust. Observe auto-scaling.
